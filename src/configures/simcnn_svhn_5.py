...
class Configures(GlobalConfigures):
    def __init__(self):
        ...
        self.dataset_name = 'svhn_5'
        self.num_classes = 5

        self.best_generation = 72
        self.best_sol_ensemble = [0, 0, 27, 0, 0]
        self.log_idx = 'recorder_4'
        self.best_acc = '95.80%'
        self.best_diff = '62.32%'
        ...
        self.num_sol_per_pop = 50  # Number of solutions in the population.
        ...
        sensitive_layer_idx = list(range(5))
        ...
        self.sensitive_layer_active_gene_ratio = [0.4, 0.5, 0.6, 0.7]
        ...
        self.non_sensitive_layer_active_gene_ratio = [0.3, 0.4]
        ...
        self.alpha = 0.9
        self.gamma = 0.95  # according to model's training accuracy
        self.acc_thresholds = {2: 0.95, 4: 0.9, 5: 0.85}  # for clip

        # communicate between explorers and the recorder
        self.signal_dir = f'{self.ga_save_dir}/signals'
        self.explorer_finish_signal_list = [f'{self.signal_dir}/explorer_{i}.sig' for i in range(5)]
        self.recorder_finish_signal_list = [f'{self.signal_dir}/recorder_{i}.sig' for i in range(5)]
