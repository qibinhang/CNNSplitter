...
class Configures(GlobalConfigures):
    def __init__(self):
        ...
        self.best_generation = 79
        self.best_sol_ensemble = [2, 2, 3, 0, 2, 0, 0, 2, 6, 2]
        self.log_idx = 'recorder_7'
        self.best_acc = f'93.85%'
        self.best_diff = f'61.61%'
        ...
        self.sensitive_layer_active_gene_ratio = [0.4, 0.5, 0.6]
        ...
        self.non_sensitive_layer_active_gene_ratio = [0.1, 0.2, 0.3, 0.4]
        ...
        self.acc_thresholds = {2: 0.95, 4: 0.95, 8: 0.85, 10: 0.8}  # for clip
